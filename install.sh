...
usage() {
  ...
  printf "%sUsage:%s\n" "$BOLD" "$RESET"
  printf "  curl -sL https://skill.sh | sh -s -- <source> [options]\n"
  printf "  curl -sL https://skill.sh | sh -s -- --installed\n\n"
  ...
  printf "%sExamples:%s\n" "$BOLD" "$RESET"
  printf "  curl -sL https://skill.sh | sh -s -- voxel51/fiftyone-skills\n"
  printf "  curl -sL https://skill.sh | sh -s -- voxel51/fiftyone-skills --skill fiftyone-develop-plugin\n"
  printf "  curl -sL https://skill.sh | sh -s -- owner/repo -g -a claude-code -y\n"
  printf "  curl -sL https://skill.sh | sh -s -- --installed\n\n"
